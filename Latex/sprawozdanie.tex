...
\begin{tikzpicture}[scale=1.5]
\begin{axis}[
title={Wykres przyspieszenia KNN dla danych znormalizowanych metodą MinMax - C++},
title style={text width=14em},
xlabel={Liczba wątków},
...
\begin{tikzpicture}[scale=1.5]
\begin{axis}[
title={Wykres przyspieszenia KNN dla danych znormalizowanych metodą MinMax - Python},
title style={text width=14em},
xlabel={Liczba wątków},
ylabel={Przyspieszenie},
xmin=0,xmax=4,
...
coordinates {
(1, 1)
(2, 0.14634275436401367/0.2372218608856201)
(3, 0.14634275436401367/0.19606773853302)
(4, 0.14634275436401367/0.20869193077087403)
};
...
\begin{tikzpicture}[scale=1.5]
\begin{axis}[
title={Wykres przyspieszenia KNN dla danych standaryzowanych - C++},
title style={text width=14em},
xlabel={Liczba wątków},
ylabel={Przyspieszenie},
xmin=0,xmax=4,
...
\begin{tikzpicture}[scale=1.5]
\begin{axis}[
title={Wykres przyspieszenia KNN dla danych standaryzowanych - Python},
title style={text width=14em},
xlabel={Liczba wątków},
ylabel={Przyspieszenie},
xmin=0,xmax=4,
...
coordinates {
(1, 1)
(2, 0.1461501121520996/0.2383200168609619)
(3, 0.1461501121520996/0.18554110527038575)
(4, 0.1461501121520996/0.20907130241394042)
};
